    ...
    void menuStudent() {
        while (true) {
            ...
            if (ch == 0) break;
                ...
                std::cout << "  [OK] Da sap xep theo GPA giam dan.\n";
            }
    ...
    void menuSubject() {
        while (true) {
            ...
            if (ch == 0) break;
                ...
                // THEM: Canh bao neu da co diem sinh vien
                if (scm.hasScoreForSubject(code)) {
                    std::cout << "  [!] CANH BAO: Mon nay da co ban ghi diem SV.\n";
                    std::cout << "  Mon nay da co diem. Ban van muon xoa mon hoc nay? (y/n): ";
                } else {
